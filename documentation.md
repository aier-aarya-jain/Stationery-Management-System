...
- basic function comments (`// Basic function to ...`) have been added to all core Java services (`AuthServiceImpl`, `InventoryServiceImpl`, `RequestServiceImpl`) and core React components (`App`, `Login`, `Register`) to help evaluators quickly understand their responsibilities.
